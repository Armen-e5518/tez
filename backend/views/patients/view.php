...
<div class="row">
    <div class="col-md-6">
        <h1>Problems</h1>
        <?php
//        Html::a(Yii::t('app', 'Add Problems'), ['problems/create', 'u_id' => $model->patients_id], ['class' => 'btn btn-primary'])
        ?> 
...
//                'problems_id',
                ...
                ['class' => 'yii\grid\ActionColumn',
                    ...
                    'urlCreator' => function ($action, $model, $key, $index) {
                        ...
                        if ($action === 'delete') {
                            $url = \yii\helpers\Url::to(['problems/delete','id' => $model->problems_id]);
                            return $url;
                        }
                    }
                ],
...
//                'conditions_id',
                ...
                ['class' => 'yii\grid\ActionColumn',
                    ...
                    'urlCreator' => function ($action, $model, $key, $index) {
                        ...
                        if ($action === 'delete') {
                            $url = \yii\helpers\Url::to(['conditions/delete','id' => $model->conditions_id]);
                            return $url;
                        }
                    }
                ],
